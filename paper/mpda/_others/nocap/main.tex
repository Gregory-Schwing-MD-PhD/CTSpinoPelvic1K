...
spine-limited acquisition can supply either count. LSTV is common, 16.3\%
...
99\%~\cite{veridah2026}. Its weights label L6 and T13 on CT, but its training scans are in-house and unreleased, so
...
estimate does not show what usual looks like. The same measures are given here from 802 records with the distribution attached
