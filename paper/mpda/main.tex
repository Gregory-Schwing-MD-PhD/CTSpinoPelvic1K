...
\begin{table*}[t]
\caption{Spinopelvic measures, median over the 756 of 802 records passing the geometric
gates, against two supine CT series.\cite{veilleux2020,hasegawa2018} Standing values are
55.0, 41.0, 13.0 and 60.0\si{\degree}.\cite{vialle2005} The end-plate is fitted to the whole
sacrum; the gate rejects 14 records where the previous carved-S1 fit lost 239.}
\label{tab:spinopelvic}
\begin{ruledtabular}
\maxwidth{%
\begin{tabular}{lccc}
Measure & This dataset (supine, $n=756$) & Veilleux ($n=200$) & Hasegawa ($n=24$) \\ \colrule
Pelvic incidence & 51.5\si{\degree} & 52.1 & 53.4 \\
Sacral slope & 36.4\si{\degree} & 36.5 & 34.1 \\
Pelvic tilt & 15.0\si{\degree} & 15.6 & 19.2 \\
Lumbar lordosis & 51.2\si{\degree} & --- & --- \\
PI $-$ LL mismatch & 0.1\si{\degree} & --- & --- \\
\end{tabular}
}
\end{ruledtabular}
\end{table*}
