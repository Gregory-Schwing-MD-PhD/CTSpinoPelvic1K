...
the classification turns on --- bony fusion against articulation without
it~\cite{koninwalz2010} --- is the one carrying clinical weight, and it is where the
disagreements lay: four of the six were III against II.
