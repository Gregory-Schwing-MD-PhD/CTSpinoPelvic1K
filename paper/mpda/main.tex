...
% ---------------------------------------------------------------------------
\begin{abstract}
\textbf{Purpose:} The reference standard for numbering an atypical spine counts caudally
from C2 on whole-spine imaging~\cite{lian2018}. Abdominal CT does not contain C2, and where a lumbosacral
