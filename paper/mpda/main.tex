...
\maxwidth{%
\begin{tabular}{lccc}
Measure & This dataset (supine, $n=575$) & Veilleux ($n=200$) & Hasegawa ($n=24$) \\ \colrule
Pelvic incidence & 52.6\si{\degree} & 52.1 & 53.4 \\
Sacral slope & 33.1\si{\degree} & 36.5 & 34.1 \\
Pelvic tilt & 19.6\si{\degree} & 15.6 & 19.2 \\
...
standing reference, as a morphological property should; slope and tilt sit inside the
published supine CT range.
...
withheld at L5: both are measured on a body isolated by cutting at the canal wall, and the
L5 transverse processes arise in front of that wall, so the cut cannot separate them. The cohort is one acquisition protocol of a colorectal screening population
