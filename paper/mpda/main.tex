...
case is planned on is regional~\cite{acr2021}, and abdominal computed tomography (CT) never
contains C2. Where a
...
CTSpine1K~\cite{ctspine1k} vertebral and CTPelvic1K~\cite{ctpelvic1k} pelvic labels on the acquisition with highest bone coverage, under a VerSe-native scheme. Validation: geometric invariants (802/802 pass); rib--vertebra incidence across 5{,}749 evaluable ribs (two offsets,
