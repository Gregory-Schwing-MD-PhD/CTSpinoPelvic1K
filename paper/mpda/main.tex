...
CT cohort. In its absence this release is the closest available proxy for the view a lumbar case
is planned on: the T12-to-S1 span with the lowest ribs and the pelvis; 377 of 802 records
acquired prone, the position of posterior lumbar surgery, with position recorded per
record; and classes for the anomalies that make level identification fail. It is a
screening population at colonography dose, not a surgical series: it supports method
