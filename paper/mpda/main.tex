...
% ---------------------------------------------------------------------------
\begin{abstract}
\textbf{Purpose:} For transitional anatomy the gold standard for numeration remains
whole-spine imaging and counting caudally from C2~\cite{lian2018}. Abdominal CT does not
contain C2, and where a lumbosacral
...
spinopelvic assessment; variant studies; opportunistic screening.
...
transitional anatomy is whole-spine imaging, counting caudally from C2~\cite{lian2018}, so
that each vertebra is named by its ordinal position whatever it carries, and no
spine-limited acquisition can supply it. LSTV is common,
