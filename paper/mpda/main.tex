...
may mean a true sixth lumbar vertebra, a T12 whose ribs are aplastic, or an S1 lumbarized
away from the sacrum~\cite{koninwalz2010}. CTSpinoPelvic1K is built so that this can be
asked of the data: whether local morphology resolves them without counting from C2. It provides 802 CT records anchoring each lumbar level on
...
decisive to a human reader in every case. Whether it nonetheless differs enough for a learned classifier to separate them, or at
...
leave four rib-free vertebrae above the sacrum, and a true sixth lumbar vertebra, a T12
with aplastic ribs and a lumbarized S1 all leave six. The count alone cannot separate the
readings.
