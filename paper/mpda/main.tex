...
\caption{Morphometry by level, T11--L5, as median, interquartile range and 5th--95th
percentile, with $n$ at right. (a) Upper end-plate width EPWu. (b) Canal width SCW and
depth SCD. (c) Transverse pedicle width PDW, the mean of the two sides. Black lines are
Panjabi's cadaveric means\cite{panjabi1991,panjabi1992}, T11--T12 EPWu digitised from
Figure 4A of the former.}
