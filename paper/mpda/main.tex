...
Two anchors make the count decidable, and Fig.~\ref{fig:anchors} shows both, the lowest rib-bearing vertebra above, \textbf{S1} carved from the sacrum below.  S1 supplies the sacral endplate
