...
% ---------------------------------------------------------------------------
\begin{abstract}
\textbf{Purpose:} A lumbar vertebra is named by counting down from C2, the reference standard
for numeration~\cite{lian2018}. Abdominal CT does not contain C2, and where a lumbosacral
transitional vertebra (LSTV) alters the count the local anatomy is ambiguous: four rib-free lumbar
