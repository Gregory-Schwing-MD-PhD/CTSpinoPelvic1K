...
99\%~\cite{veridah2026}. Its released weights label L6 and T13 on CT, but the 1{,}536 CT
scans they were trained on are an in-house cohort that is not released, so the capability
exists as weights and not as a labeled dataset. VerSe~\cite{verse2021,versedata2021}
