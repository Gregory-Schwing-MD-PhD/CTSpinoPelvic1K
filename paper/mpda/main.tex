...
Transverse pedicle width, the mean of the two sides. Lines are the published series for
each measure, keyed below; Panjabi is drawn in black as the series the text cites.}
...
lumbar spine and adding the width of each distribution. The published series drawn
alongside disagree among themselves by 21 to 69\%.
