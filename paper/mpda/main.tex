...
\begin{table*}[t]
\caption{Spinopelvic measures, median over the 563 of 802 records passing the geometric
gates, against two supine CT series.\cite{veilleux2020,hasegawa2018} Standing values are
55.0, 41.0, 13.0 and 60.0\si{\degree}.\cite{vialle2005}}
\label{tab:spinopelvic}
\begin{ruledtabular}
\maxwidth{%
\begin{tabular}{lccc}
Measure & This dataset (supine, $n=563$) & Veilleux ($n=200$) & Hasegawa ($n=24$) \\ \colrule
Pelvic incidence & 52.7\si{\degree} & 52.1 & 53.4 \\
Sacral slope & 33.2\si{\degree} & 36.5 & 34.1 \\
Pelvic tilt & 19.7\si{\degree} & 15.6 & 19.2 \\
Lumbar lordosis & 49.6\si{\degree} & --- & --- \\
...
figures. A standard error describes the mean, not the spread of individuals. The same
...
intervals, which is what makes their widths comparable: a confidence interval bounds a
...
cut at. Those two and the spinopelvic angles, which rest on the carved S1 end-plate, are
the provisional part of this release; a substructure label gives body and sacral plate
directly and is the planned revision, which the version DOI carries. The cohort is one acquisition protocol of a colorectal screening population
...
\newblock Practice parameter for the performance of {CT} of the spine, revised 2022,
\newblock \url{https://www.asnr.org/wp-content/uploads/2019/06/CT-Spine-1.pdf}.

\bibitem{acrmri2023}
{American College of Radiology},
\newblock Practice parameter for the performance of {MRI} of the adult spine, revised 2023,
...
\bibitem{hahn2017}
G.~J. Hahn, W.~Q. Meeker and L.~A. Escobar, Statistical Intervals, Wiley,
2nd edition, 2017.
