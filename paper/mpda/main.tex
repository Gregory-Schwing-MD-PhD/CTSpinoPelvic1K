...
percentile, with $n$ at right, in Panjabi's nomenclature. (a) Upper end-plate width
EPWu. (b) Spinal canal width SCW and depth SCD. (c) Transverse pedicle width PDW, the
mean of the two sides (Panjabi reports PDWr and PDWl separately). Black lines are
...
level.\cite{benzel2015} A standard error describes the mean, not the spread of individuals,
