...
check of Table~\ref{tab:qc} --- the quality-control gate on the rib class labels, which
matches each rib to the vertebra its number implies --- has nothing to test.
