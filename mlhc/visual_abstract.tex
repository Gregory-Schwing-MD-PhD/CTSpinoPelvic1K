...
\node[hdr=cpseudo] at (14.5, 5.9) {\textsc{Pseudolabel}\\[-1pt]\footnotesize fill the missing region};
...
\draw[flow, draw=cpseudo!75!black] (train.east) -- (dense.west)
  ...
  {782 spine-anchored\\+ 20 pelvic-only\\\textbf{= 802}};
\node[lbl=cgray, font=\sffamily\scriptsize, align=center] at (12.2,-3.6)
  {spine GT prioritized over pelvic;\\the 20 with no spine get a pseudo-spine,\\radiologist-verified for enumeration};
