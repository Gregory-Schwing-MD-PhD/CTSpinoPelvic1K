...
\useasboundingbox (-1.7,-6.3) rectangle (20.2,6.6);
...
\node[hdr=cpseudo] at (13.8, 5.9) {\textsc{Pseudolabel}\\[-1pt]\footnotesize complete the pelvis};
\node[hdr=crib]    at (17.8, 5.9) {\textsc{+ Ribs}\\[-1pt]\footnotesize TotalSegmentator, v3};

% ── (1) source mask stacks (titles BELOW each render) ──
\pagestack{spine}{0}{2.7}{cspine}{\rSpine}
\node[cap=cspine] at (0,0.85) {CTSpine1K spine GT\\[2pt]\num{784} masks};
\pagestack{pelv}{0}{-2.7}{cpelv}{\rPelvis}
\node[cap=cpelv] at (0,-4.55) {CTPelvic1K pelvic GT\\[2pt]\num{714} masks};

% ── (2) match: } brace -> fused; -> arrows -> separate ──
\pagestack{sonly}{5}{3.7}{cspine}{\rSpineOnly}
\node[cap=cspine] at (5,1.85) {spine-only\\[2pt]\num{440}};
\pagestack{fused}{5}{0}{cfuse}{\rFused}
\node[cap=cfuse] at (5,-1.85) {fused (spine+pelvis)\\[2pt]\num{342}};
\pagestack{ponly}{5}{-3.7}{cpelv}{\rPelvicOnly}
\node[cap=cpelv] at (5,-5.55) {pelvic-only\\[2pt]\num{371}};
...
\node[lbl=cfuse, font=\sffamily\scriptsize, fill=white, inner sep=1pt] at (3.6,1.05) {same\\acquisition};
...
\node[cap=cpseudo] at (13.8,-1.85) {dense spine\,+\,pelvis\\[2pt]\num{782}};
...
\node[lbl=cgray, font=\sffamily\scriptsize, align=center] at (11.7,-3.4)
  {pelvic-only 371\\held out};

% ── (5) ribs (TotalSegmentator) ──
\pagestack{ribs}{17.8}{0}{crib}{\rRibs}
\node[cap=crib] at (17.8,-1.85) {spine\,+\,pelvis\,+\,ribs\\[2pt]\num{782}};
