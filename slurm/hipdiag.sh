...
#SBATCH --output=logs/hipdiag_%j.out
#SBATCH --error=logs/hipdiag_%j.err
set -euo pipefail
...
singularity exec --bind "$(pwd)":/w,"${DATA_DIR}":/data --pwd /w \
    ...
    python3 -u /w/scripts/diagnose_hip_disagreement.py --src /data/hf_export_v6 \
      --controls 24 \
      --flagged 0012 0065 0135 0146 0172 0186 0376 0410 0471 0513 0746 0830 0917 0938 0957 1124 1145 1148
