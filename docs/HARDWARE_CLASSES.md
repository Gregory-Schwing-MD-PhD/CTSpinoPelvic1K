...
| id | name | what it is |
|---|---|---|
| 62 | `hardware` | metal that no rule could name; a placeholder, not an answer |
| 63 | `hardware_cage` | interbody cage or spacer, in the disc space |
| 64 | `hardware_screw_rod` | pedicle screws and rods — spinal posterior instrumentation |
| 65 | `hardware_plate` | plates and other flat fixation |
| 66 | `hardware_arthroplasty` | joint **replacement**: femoral stem, head, acetabular cup |
| 67 | `hardware_si_screw` | iliosacral fixation crossing the sacroiliac joint |
| 68 | `hardware_osteosynthesis` | metal holding parts of the **same bone** together |

### 66 against 68 — the distinction that matters most
...
68 (82 in v8, 66 in v9) was briefly named `hardware_fracture_fix`, which was a description rather than a term.
